...
<head>
    ...
    <link rel="icon" href="'.$domaine_cdn.'/media/img/logo.png" type="image/x-icon">
    <title>Castle & Castle</title>
                    ...
                    <tr>
                        <td class="content-wrap" valign="top">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="td-logo">
                                        <a href="' . $domaine . '"><img src="'.$domaine_cdn.'/media/img/logo.png" height="100"/></a> <br/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
                                        <p>Veuillez confirmer la modification  votre adresse e-mail en cliquant sur le lien ci-dessous.</p>
                                ...
                                <tr style="text-align:center">
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="' . $domaine . '/update-email?token=' .$mailToken. '" class="btn-primary" itemprop="url">Confirmer mon email</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
                                ...
                                <tr>
                                    <td valign="top">Cordialement, <br/>Castle & Castle</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <table width="100%">
        <tr>
            <td class="aligncenter content-block" align="center" valign="top">
                ...
                Copyright © 2022 Castle & Castle. Tous droits réservés.
            </td>
        </tr>
    </table>
</div>
