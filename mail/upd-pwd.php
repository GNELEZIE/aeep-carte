                    ...
                    <tr>
                        <td class="content-wrap" valign="top">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="td-logo">
                                        <a href="' . $asset . '"><img src="'.$asset.'/media/logoAEEK.png" height="100"/></a> <br/>
                                    </td>
                                </tr>
                                <tr>
                                     <td class="content-block" valign="top">
                                        ...
                                        Pour modifier votre mot de passe AEEK -Kasséré , vous devez cliquer sur le lien ci-dessous.
                                    </td>
                                </tr>
                                 <tr>
                                     <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="'.$domaine.'/update-pw/?token='.$mailToken.'" class="btn-primary" itemprop="url">Modifier votre mot de passe</a>
                                    </td>
                                </tr>
                                 <tr>
                                 <td class="content-block" valign="top">
                                ...
                                <tr>
                                    <td valign="top">Cordialement, <br/>AEEK -Kasséré </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <table width="100%">
        <tr>
            <td class="aligncenter content-block" align="center" valign="top">
                ...
                Copyright © 2022 AEEK -Kasséré. Tous droits réservés.
            </td>
        </tr>
    </table>
</div>
