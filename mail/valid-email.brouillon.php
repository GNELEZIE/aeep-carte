                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block" valign="top">
                                        <p>Félicitation pour votre inscription.Veuillez confirmer votre adresse e-mail en cliquant sur le lien ci-dessous.</p>
                                ...
                                <tr style="text-align:center">
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="' . $domaine . '/validation/?token=' . $mailToken . '" class="btn-primary" itemprop="url">Confirmer mon email</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
